    ...
    def post(self, request):
        ...
        if selected_type == "drug_in":
            ...
            if len(in_drugs) > 0:
                ...
                return printout(request, in_drugs_list, "drugin")
            ...
            if len(out_drugs) > 0:
                ...
                return printout(request, out_drugs_list, "drugout")
            ...
            if len(in_vaccines) > 0:
                ...
                return printout(request, in_vaccines_list, "vaccinein")
            ...
            if len(out_vaccines) > 0:
                ...
                return printout(request, out_vaccines_list, "vaccineout")
            ...
            if len(in_equipments) > 0:
                ...
                return printout(request, in_equipments_list, "equipmentin")
            ...
            return printout(request, out_equipments_list, "equipmentout")

        elif selected_type == "receipt_in":
            in_receipts = ReceiptIn.objects.filter(
                date=selected_date, kebele=selected_kebele
            )
