...
class DrugOut(models.Model):
    ...
    approved_by = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="approved_by"
    )
    ...
    def __str__(self):
        return self.drug.drug_type + "-" + self.kebele.name + "-" + self.batch_number
...
class DrugOutCashDeposit(models.Model):
    ...
    confirmed_by = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="drug_out_confirmed_by"
    )
    remark = models.CharField(max_length=200, null=True)
